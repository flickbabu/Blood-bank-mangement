  ...
  <div class="col-sm-3" style="background-color:black;">
    ...
    <table class="table table-bordered">
             ...
             <?php  
               ...
               $select = mysqli_query($conn,"select * from patient join request_2 on patient.patient_id=request_2.patient_id where status='Pending'");
               ...
               ?>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;padding:20px !important"> 
                      <button class="btn btn-primary"><a href="manage2.php?req_id=<?php echo $req_id; ?>" style="color:white;text-deccoration:none;">Manage Request</a></button>
                  </td>
                  </tr>  
                ...
                <?php
                 ...
                 ?>
                   <tr>
                 <td colspan=7 style="text-align:center; font-size:20px !important;">No requested blood yet</td>
               </tr> 
                 <?php
