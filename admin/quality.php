...
$message="";
    ...
    //SELECT FROM DATABASE STORE
     ...
     $store_id = $rowss['blood_id'];

     $sum = $qul + $amount;

     //echo $sum;

    $update = mysqli_query($conn, "update blood_store set quantity='$sum' where blood_id='$store_id'"); 
    ...
    //  if(mysqli_num_rows($take) == null){

    //     $qull = 0;

    //     $sum = $qull + $amount;

    //     $update = mysqli_query($conn, "update blood_store set quantity='$sum' where blood_group='$blood'"); 
    //  }
    //  else{
