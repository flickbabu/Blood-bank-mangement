  ...
  <div class="row">
    ...
    <div class="col-sm-10" style="background-color:white;">
          ...
          <div class="sub_menu">
            ...
            ?>
                  <h4>Logged In as : <?php  echo $rowss['patient_name'];?></h4>
            </div><br>
            <br>
     ...
     <table class="table table-bordered">
             ...
             <?php  
               ...
               $select = mysqli_query($conn,"select * from patient join request_2 on patient.patient_id=request_2.patient_id where email='$email'");
               ...
               ?>
                  ...
                  <tr>
                    ...
                    <?php $counter++; ?>
                    <td style="text-align:center;padding:20px !important"><?php echo $row['patient_name'] ;?></td>
                    ...
                    <td style="text-align:center;padding:20px !important"><?php echo $row['unit'].' Unit( Ml)';?></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="form-group">
          ...
          <br>
          <input type="text" name="donor_id" value="<?php  echo $rowss['patient_id'];?>">
          <input type="text" name="dayin" value="<?php echo date('m') .'/ '.date('d').'/ '.date('Y'); ?>">
        </div>
