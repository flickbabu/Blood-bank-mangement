  ...
  <div class="row">
    ...
    <table class="table table-bordered">
             ...
             <?php  
               ...
               $select = mysqli_query($conn,"select * from patient join request_2 on patient.patient_id=request_2.patient_id where req_id='$req_id'");
               ...
               ?>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;padding:20px !important"> 
                      <button class="btn btn-primary"><a href="approve2.php?blood_id=<?php echo $blood_id; ?>" style="color:white;text-decoration:none;">Approved Request</a></button>
                  </td>
                  </tr>  
