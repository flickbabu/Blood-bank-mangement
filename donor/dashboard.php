...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-10" style="background-color:white;">
      ...
      ?>
      <h4>Logged In as : <?php  echo $row['donor_name'];?></h4>
      </div>
      <center> <h3>Donor Dashboard</h3></center>   
      ...
      <section>
        ...
        <br>
         <p>Send Pending Blood Request:
                ...
                <?php 
                        $select= mysqli_query($conn,"select * from donor join request on donor.donor_id=request.donor_id where status='Pending' and email='$email'");
        ...
        <br>
         <p>Approved Blood Request:
                ...
                <?php 
                        $select= mysqli_query($conn,"select * from donor join request on donor.donor_id=request.donor_id where status='Approved' and email='$email'");
                        $rowcount = mysqli_num_rows($select);
                       echo $rowcount;
                    ?>
